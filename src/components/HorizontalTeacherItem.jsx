    ...
    <div className="p-4 rounded-xl border border-gray-300 bg-white hover:shadow-2xl transition-shadow duration-500 flex flex-col md:flex-row gap-x-5">
      ...
      <div className="px-2 mt-5 md:mt-0 flex-1">
        ...
        <div className="mt-5 flex flex-col sm:flex-row gap-3 w-full">
          <Popup
            buttonContent={t("teacheritem.bookLesson")}
            buttonClass="bg-blue-light text-blue-dark hover:bg-blue-dark hover:text-white hover:shadow-lg transition-all duration-500 font-medium py-3 md:py-2 px-4 rounded-lg text-center"
          />
          <Popup
            buttonContent={t("teacheritem.contactNow")}
            buttonClass="bg-blue-dark text-white hover:bg-blue-light hover:text-blue-dark hover:shadow-lg transition-all duration-500 font-medium py-3 md:py-2 px-4 rounded-lg text-center"
          />
        </div>
      </div>
    </div>
